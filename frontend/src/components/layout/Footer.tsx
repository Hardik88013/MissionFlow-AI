      ...
      <Container>
            ...
            <div key={group.title}>
              ...
              <ul className="space-y-3">
                {group.links.map((link) => (
                  <li key={link.label}>
                    <a onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }}
                      href={link.href}
        ...
        <div className="mt-16 border-t border-border/40 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <div className="flex gap-4">
            <a onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} href="#" className="hover:text-foreground transition-colors">Privacy Policy</a>
            <a onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} href="#" className="hover:text-foreground transition-colors">Terms of Service</a>
          </div>
        </div>
      </Container>
    </footer>
