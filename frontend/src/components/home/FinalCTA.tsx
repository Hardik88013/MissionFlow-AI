      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <Button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} size="lg" className="w-full sm:w-auto shadow-lg hover:shadow-primary/20">
              REQUEST DEMO <ArrowRight className="ml-2 w-4 h-4" />
            </Button>
            <Button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} variant="outline" size="lg" className="w-full sm:w-auto bg-background/50 backdrop-blur-sm">
              EXPLORE PLATFORM
            </Button>
          </div>
        </div>
