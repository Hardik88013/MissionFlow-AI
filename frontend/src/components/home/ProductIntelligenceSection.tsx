      ...
      <Container>
        ...
        <div className="flex overflow-x-auto hide-scrollbar border-b border-border/50 mb-10 pb-px [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <div className="flex gap-8 min-w-max px-2">
            {tabs.map((tab, idx) => (
              <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} 
                key={tab}
        ...
        <div className="bg-surface rounded-2xl border border-border/60 shadow-xl overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-64 border-b lg:border-b-0 lg:border-r border-border/50 flex flex-col bg-surface/50">
            ...
            <div className="p-4 flex flex-row lg:flex-col gap-1 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="flex-shrink-0 flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-muted-foreground hover:bg-surface-elevated font-medium transition-colors">
                <Car className="w-4 h-4" /> Vehicle Details
              </button>
              <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="flex-shrink-0 flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm bg-primary/10 text-primary dark:text-[#69E0A5] font-semibold transition-colors">
          ...
          <div className="flex-1 relative min-h-[350px] lg:min-h-[500px] bg-[#1a1f2b]">
            ...
            <div className="absolute bottom-4 right-4">
              <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="bg-surface/90 backdrop-blur-md px-3 py-1.5 rounded-lg text-xs font-bold text-foreground border border-border/40 hover:bg-surface-elevated">
                Terrain v
              </button>
            </div>
        ...
        <div className="mt-8 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 border border-border/40 bg-surface rounded-2xl p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between xl:w-1/3 w-full gap-4">
            ...
            <Button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} variant="outline" size="sm" className="whitespace-nowrap bg-background hover:bg-surface-elevated font-semibold text-xs border-border/60">
