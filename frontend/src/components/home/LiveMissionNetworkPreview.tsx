      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-row lg:flex-col gap-2 overflow-x-auto pb-2 lg:pb-0 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <button onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} className="flex items-center gap-3 w-auto lg:w-full flex-shrink-0 whitespace-nowrap bg-primary/10 text-primary dark:text-[#69E0A5] font-semibold px-4 py-3 rounded-lg shadow-sm border border-primary/20">
              <MapIcon className="w-5 h-5 text-primary dark:text-[#69E0A5]" />
              <span className="text-sm">Live Map</span>
            </button>
            <button onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} className="flex items-center gap-3 w-auto lg:w-full flex-shrink-0 whitespace-nowrap hover:bg-surface-elevated text-muted-foreground font-medium px-4 py-3 rounded-lg transition-colors">
            ...
            <button onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} className="flex items-center justify-between w-auto lg:w-full flex-shrink-0 whitespace-nowrap hover:bg-surface-elevated text-muted-foreground font-medium px-4 py-3 rounded-lg transition-colors">
          ...
          <div className="lg:col-span-4 bg-surface rounded-2xl border border-border/50 shadow-sm p-6 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} className="text-xs font-semibold bg-surface-elevated px-3 py-1.5 rounded text-foreground border border-border/60 hover:bg-border/20 transition-colors">
                All Operations ▾
              </button>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }} className="text-xs font-semibold text-[#00A859] hover:underline">View All →</button>
            </div>
