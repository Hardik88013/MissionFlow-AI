      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-row lg:flex-col gap-2 overflow-x-auto pb-2 lg:pb-0 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <button onClick={() => alert("This is development phase coming soon - Developer: Hardik")} className="flex items-center gap-3 w-auto lg:w-full flex-shrink-0 whitespace-nowrap bg-primary/10 text-primary dark:text-[#69E0A5] font-semibold px-4 py-3 rounded-lg shadow-sm border border-primary/20">
              <MapIcon className="w-5 h-5 text-primary dark:text-[#69E0A5]" />
              <span className="text-sm">Live Map</span>
            </button>
            <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="flex items-center gap-3 w-auto lg:w-full flex-shrink-0 whitespace-nowrap hover:bg-surface-elevated text-muted-foreground font-medium px-4 py-3 rounded-lg transition-colors">
            ...
            <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="flex items-center justify-between w-auto lg:w-full flex-shrink-0 whitespace-nowrap hover:bg-surface-elevated text-muted-foreground font-medium px-4 py-3 rounded-lg transition-colors">
          ...
          <div className="lg:col-span-6 relative bg-surface-elevated rounded-2xl overflow-hidden border border-border/50 shadow-inner min-h-[300px] md:min-h-[400px]">
            ...
            <div className="absolute inset-0 p-4">
              ...
              <div className="hidden md:flex absolute bottom-6 left-6 flex-col bg-surface rounded-lg shadow-md border border-border/40">
                <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="p-2 border-b border-border/40 hover:bg-surface-elevated text-foreground font-bold">+</button>
                <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="p-2 hover:bg-surface-elevated text-foreground font-bold">-</button>
              </div>
          ...
          <div className="lg:col-span-4 bg-surface rounded-2xl border border-border/50 shadow-sm p-6 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="text-xs font-semibold bg-surface-elevated px-3 py-1.5 rounded text-foreground border border-border/60 hover:bg-border/20 transition-colors">
                All Operations ▾
              </button>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={(e) => { e.preventDefault(); alert('This is development phase coming soon - Developer: Hardik'); }} className="text-xs font-semibold text-[#00A859] hover:underline">View All →</button>
            </div>
            ...
            <div className="flex flex-col gap-4 flex-1">
              ...
              <div className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-3 text-xs">
                ...
                <span className="bg-primary/10 text-primary dark:text-[#69E0A5] px-2 py-0.5 rounded text-[10px] font-bold">En route</span>
              ...
              <div className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-3 text-xs">
                ...
                <span className="bg-primary/10 text-primary dark:text-[#69E0A5] px-2 py-0.5 rounded text-[10px] font-bold">On time</span>
              ...
              <div className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-3 text-xs">
                ...
                <span className="bg-danger/10 text-danger px-2 py-0.5 rounded text-[10px] font-bold">Delayed</span>
              ...
              <div className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-3 text-xs">
                ...
                <span className="bg-surface-elevated text-muted-foreground px-2 py-0.5 rounded text-[10px] font-bold">Delivered</span>
