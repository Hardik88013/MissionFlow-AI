      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface border border-border/50 rounded-2xl p-6 shadow-xl">
          ...
          <button
            onClick={() => googleLogin()}
            disabled={isLoading}
            className="mt-4 w-full h-11 rounded-lg bg-surface hover:bg-surface-elevated border border-border text-foreground font-semibold flex items-center justify-center gap-2 transition-colors"
          >
